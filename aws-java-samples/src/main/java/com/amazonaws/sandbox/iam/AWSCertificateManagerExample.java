 ...
 *
 * Input parameters: CertificateStatuses - An array of strings that contains the
 * statuses to use for filtering. MaxItems - The maximum number of certificates
 * to return in the response. NextToken - Use when paginating results.
 *
 * Output parameters: CertificateSummaryList - A list of certificates. NextToken
 * - Use to show additional results when paginating a truncated list.
 *
 */
