...
import ujr.aws.lambda.event.handler.LambdaEventReceiver;

/**
 * A simple test harness for locally invoking your Lambda function handler.
 */
@RunWith(MockitoJUnitRunner.class)
public class LambdaEventReceiverTest {
    ...
    public void testLambdaFunctionHandler() {
        LambdaEventReceiver handler = new LambdaEventReceiver(s3Client);
